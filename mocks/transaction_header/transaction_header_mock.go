...
// Source: business/transaction_header/domain.go
...
func (m *MockUsecase) GetAll(ctx context.Context) ([]transaction_header.Domain, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) GetByID(ctx context.Context, transactionId int) (transaction_header.Domain, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsecase) Store(ctx context.Context, coffeesDomain *transaction_header.Domain) (transaction_header.Domain, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Find(ctx context.Context) ([]transaction_header.Domain, error) {
	m.ctrl.T.Helper()
...
// Store mocks base method.
func (m *MockRepository) Store(ctx context.Context, coffeesDomain *transaction_header.Domain) (transaction_header.Domain, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Store", ctx, coffeesDomain)
	ret0, _ := ret[0].(transaction_header.Domain)
	ret1, _ := ret[1].(error)
